/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fae5528faf10f0661555849fcbdf5d37)
// Runtime types generated with workerd@1.20251213.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		APP_ENV: "production";
		APP_NAME: string;
		APP_AUTH_COOKIE: string;
		APP_AUTH_COOKIE_ACCESS: string;
		APP_AUTH_COOKIE_REFRESH: string;
		APP_AUTH_COOKIE_SECRET: string;
		APP_DOMAIN: string;
		APP_PDF_SERVICE_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_DATABASE_ID: string;
		CLOUDFLARE_D1_TOKEN: string;
		TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		VITE_APP_PDF_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_NAME" | "APP_AUTH_COOKIE" | "APP_AUTH_COOKIE_ACCESS" | "APP_AUTH_COOKIE_REFRESH" | "APP_AUTH_COOKIE_SECRET" | "APP_DOMAIN" | "APP_PDF_SERVICE_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "VITE_APP_PDF_URL" | "VITE_APP_FRONTEND_URL">> {}
}
